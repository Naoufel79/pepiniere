...
# Adjusted for moving settings to a subdirectory
...
SECRET_KEY = 'django-insecure-9+zujz-g1+v-o=ztyh7m$_^#i72+d0s+0z#+#n-snvw_0c^yzb'
...
ROOT_URLCONF = 'Point_De_Vente.urls'
...
WSGI_APPLICATION = 'Point_De_Vente.wsgi.application'
