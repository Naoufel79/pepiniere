...
# Railway Deployment Script for Django App
# This script prepares the application for deployment on Railway.app

echo "🚀 Starting Railway deployment preparation..."

# Set environment variables if not already set
export DJANGO_SETTINGS_MODULE=Point_De_Vente.settings.production
